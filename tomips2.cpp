...
void para_mips()
{
   if(isnum(midcode_vector[midcode_index].result))
   {
       ...
       // 
       genmips("\tsubi\t$sp,$sp,4");
       genmips("\tli\t$t8,"+midcode_vector[midcode_index].result);
       genmips("\tsw\t$t8,0($sp)");
   }
   //
   else 
   {
       genmips("\tsubi\t$sp,$sp,4");
       lw_mips("$t8",midcode_vector[midcode_index].result);
       genmips("\tsw\t$t8,0($sp)");
   }
}
...
void algbra_mips()
{
   ...
   {
       genmips("\tli\t$t8,"+midcode_vector[midcode_index].arg1);
       temp1="$t8";
   }
   else
   {
       temp1=find_in_register(midcode_vector[midcode_index].arg1);
       if(temp1=="")
       {
            temp1=allocate_register(midcode_vector[midcode_index].arg1);
            lw_mips(temp1,midcode_vector[midcode_index].arg1);
       }
       //找到了这个临时变量的寄存器 在temp里
       else if(temp1=="full")
       {
           //满了
           temp1="$t8";
   ...
   {
       genmips("\tli\t$t9,"+midcode_vector[midcode_index].arg2);
       temp2="$t9";
   }
   else
   {
       temp2=find_in_register(midcode_vector[midcode_index].arg2);
       if(temp2=="")
       {
            temp2=allocate_register(midcode_vector[midcode_index].arg2);
            lw_mips(temp2,midcode_vector[midcode_index].arg2);
       }
       //找到了这个临时变量的寄存器 在temp里
       else if(temp2=="full")
       {
   ...
   {
       genmips("\tadd\t$a3,"+temp1+","+temp2);
       sw_mips("$a3",midcode_vector[midcode_index].result);
   }

   else if(midcode_vector[midcode_index].op=="-")
   {
       genmips("\tsub\t$a3,"+temp1+","+temp2);
       sw_mips("$a3",midcode_vector[midcode_index].result);    
   }
   
   else if(midcode_vector[midcode_index].op=="*")
   {
       genmips("\tmul\t$a3,"+temp1+","+temp2);
       sw_mips("$a3",midcode_vector[midcode_index].result);      
   }
   
   else if(midcode_vector[midcode_index].op=="/")
   {
       genmips("\tdiv\t$a3,"+temp1+","+temp2);
       genmips("\tmflo\t$a3");
       sw_mips("$a3",midcode_vector[midcode_index].result);       
   }
...
void logic_mips()
{
   ...
   {
       lw_mips("$t8",midcode_vector[midcode_index].arg1);
   }
   //arg2 立即数或者变量
   if(isnum(midcode_vector[midcode_index].arg2))
   {
   ...
   {
       lw_mips("$t9",midcode_vector[midcode_index].arg2);
   }
   ...
   if(midcode_vector[midcode_index].op==">")
   {
       ...
       {
           genmips("\tbgt\t$t8,$t9,"+midcode_vector[midcode_index+1].result);
       }
       else
       {
           genmips("\tble\t$t8,$t9,"+midcode_vector[midcode_index+1].result);
       }
   }
   else if(midcode_vector[midcode_index].op=="<")
   {
       if(midcode_vector[midcode_index+1].op=="j" || midcode_vector[midcode_index+1].op=="jeq")
       {
           genmips("\tblt\t$t8,$t8,"+midcode_vector[midcode_index+1].result);
       }
       else
       {
           genmips("\tbge\t$t8,$t9,"+midcode_vector[midcode_index+1].result);
       }
   }
   else if(midcode_vector[midcode_index].op==">=")
   {
       ...
       {
           genmips("\tblt\t$t8,$t9,"+midcode_vector[midcode_index+1].result);
       }
   }
   else if(midcode_vector[midcode_index].op=="<=")
   {
   ...
   else if(midcode_vector[midcode_index].op=="==")
   {
       if(midcode_vector[midcode_index+1].op=="j" || midcode_vector[midcode_index+1].op=="jeq")
       {
           genmips("\tbeq\t$t8,$t9,"+midcode_vector[midcode_index+1].result);
       }
       else
       {
           genmips("\tbne\t$t8,$t9,"+midcode_vector[midcode_index+1].result);
       }
   }
   else if(midcode_vector[midcode_index].op=="!=")
   {
...
void assign_mips()
{
   ...
   sw_mips("$t8",midcode_vector[midcode_index].result);
}
...
void assign_array()
{
    ...
    if(isnum(midcode_vector[midcode_index].arg2))
    {
        genmips("\tli\t$t8,"+midcode_vector[midcode_index].arg2);
    }
    else
    {
        lw_mips("$t8",midcode_vector[midcode_index].arg2);
    }
    genmips("\tsll\t$t8,$t8,2\n");
    ...
    if(offest==-1)
    {
        genmips("\tla\t$t9,"+midcode_vector[midcode_index].result);
        genmips("\tadd\t$a3,$t9,$t8");
    }
    else
    {
        genmips("\tla\t$t9,"+to_string(offest)+"($fp)");
        genmips("\tsub\t$a3,$t9,$t8");
    }
    ...
    if(isnum(midcode_vector[midcode_index].arg1))
    {
        genmips("\tli\t$t9,"+midcode_vector[midcode_index].arg1);
    }
    else 
    {
        lw_mips("$t9",midcode_vector[midcode_index].arg1);
    }
...
void equal_array()
{
    ...
    if(offest==-1)
    {
        genmips("\tla\t$t9,"+midcode_vector[midcode_index].arg1);
        genmips("\tadd\t$a3,$t9,$t8");
    ...
    sw_mips("$t9",midcode_vector[midcode_index].result);
}
...
int var_addr(string name)
{
    if(contain_variable(name))
    {
        ...
        else
        {
            ...
            {
                return -(f.parameter_num-s.addr)*4+4;
            }
            // 不是参数了
            // 在fp以下？
...
// 要存储初值。
    else if(midcode_vector[midcode_index].op=="const")
    {
        ...
        genmips("\tli\t$t8,"+to_string(val));
        genmips("\tsw\t$t8,"+to_string(var_addr(name))+"($fp)"+"\t#store const");
    }
}
